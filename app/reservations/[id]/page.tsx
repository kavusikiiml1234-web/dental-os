...
export default function ReservationDetail() {
  ...
  if (!reservation) {
    return (
      <div className="p-6">
        <div className="text-center text-gray-500">予約が見つかりません</div>
      </div>
    )
  }
      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="bg-white rounded-xl shadow p-6 mb-6">
          <div className="flex justify-between items-start mb-6">
            ...
            <span className={`px-3 py-1 text-sm font-medium rounded-full ${statusColors[reservation.status]}`}>
          ...
          <div className="grid grid-cols-2 gap-6">
            <div>
              ...
              <p className="text-lg">
                ...
                <span className="ml-2 font-bold">{reservation.start_time?.slice(0, 5)}</span>
              </p>
            </div>
            <div>
              <h3 className="text-sm font-medium text-gray-500 mb-1">種別</h3>
              <select
                value={category}
            ...
            <div>
              <h3 className="text-sm font-medium text-gray-500 mb-1">ユニット</h3>
              <select
                value={unitId}
        ...
        <div className="bg-white rounded-xl shadow p-6 mb-6">
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div>
              ...
              <p>{reservation.patients?.phone || '-'}</p>
            </div>
            <div>
              <h3 className="text-sm font-medium text-gray-500">生年月日</h3>
              <p>{reservation.patients?.birth_date || '-'}</p>
            </div>
            <div>
              <h3 className="text-sm font-medium text-gray-500">性別</h3>
              <p>
                {reservation.patients?.gender === 'male' ? '男性' : 
                 reservation.patients?.gender === 'female' ? '女性' : 'その他'}
              </p>
            </div>
          </div>
          ...
          <div className="mt-4 pt-4 border-t">
            <Link
              href={`/patients/${reservation.patient_id}`}
