        ...
        <div className="bg-blue-50 rounded-xl p-6 mb-6">
          ...
          <div className="space-y-4">
            <div className="flex items-start gap-3">
              ...
              <div>
                <p className="font-medium text-blue-900">受付でチェックイン</p>
                <p className="text-sm text-blue-700">予約完了時のQRコードをご提示ください</p>
              </div>
            </div>
            <div className="flex items-start gap-3">
              ...
              <div>
                <p className="font-medium text-blue-900">保険証の確認</p>
                <p className="text-sm text-blue-700">初診・月初めの方は保険証をご提示ください</p>
              </div>
            </div>
            <div className="flex items-start gap-3">
              ...
              <div>
                <p className="font-medium text-blue-900">待合室でお待ちください</p>
                <p className="text-sm text-blue-700">順番になりましたらスマホに通知が届きます</p>
              </div>
            </div>
          </div>
        </div>
