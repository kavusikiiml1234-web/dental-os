                  ...
                  <div className="mb-6">
                    ...
                    <div className="bg-red-50 border-l-4 border-red-500 p-4 rounded">
                      ...
                      <div className="flex gap-4 mt-2 text-sm text-red-600">
                        ...
                        <span>発症: <strong>{latestInterview.symptom_duration || '-'}</strong></span>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-2 gap-6">
                    ...
                    <div>
                      ...
                      <div className="bg-gray-50 p-3 rounded">
                        <p>{latestInterview.medical_history || '特になし'}</p>
                      </div>
                    </div>
                    ...
                    <div>
                      ...
                      <div className={`p-3 rounded ${latestInterview.allergies && latestInterview.allergies !== 'なし' ? 'bg-orange-50 border border-orange-200' : 'bg-gray-50'}`}>
                        <p className={latestInterview.allergies && latestInterview.allergies !== 'なし' ? 'text-orange-700 font-medium' : ''}>
                          {latestInterview.allergies || 'なし'}
                        </p>
                      </div>
                    </div>
                    ...
                    <div>
                      ...
                      <div className="bg-gray-50 p-3 rounded">
                        <p>{latestInterview.current_medications || 'なし'}</p>
                      </div>
                    </div>
                    ...
                    <div>
                      ...
                      <div className="bg-gray-50 p-3 rounded text-sm">
                        <p>歯科不安: {latestInterview.dental_anxiety || '-'}</p>
                        <p>喫煙: {latestInterview.lifestyle_smoking ? 'あり' : 'なし'}</p>
                        <p>妊娠: {latestInterview.pregnancy_status || '-'}</p>
                      </div>
                    </div>
                  </div>
                </div>
